...
if __name__ == '__main__':
    ...
    for ps in program_studies:
        ...
        for model in MODELS:
            ...
            original_path = f"Output3/{ps}/Mapping/mapping_{sim_type}_{model}_{ps}.xlsx"
            expanded_path = f"Output3/{ps}/Mapping/expanded_mapping_{sim_type}_{model}_{ps}.xlsx"
        ...
        if ps_results:
            ...
            out_path = f"Output3/{ps}/Evaluasi/evaluation_results_{ps}.xlsx"
